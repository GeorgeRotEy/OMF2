page 50038 "Sales Inv. S. - Fact. colegios"
{
    //
    // Mod. S2G (JPB) FVC001: Facturación de ventas desde colegios
    //   - Página realizada a partir de la pág. 47 (Sales Invoice Subform) a 31/07/2019
        ...
        area(content)
        {
            repeater(repeater)
            {
                ...
                field("Unit Price"; Rec."Unit Price")
                {
                    ...
                    Enabled = NOT RowIsText;
                    ShowMandatory = Rec."No." <> '';
                    ToolTip = 'Specifies the price for one unit on the sales line.', Comment = 'ESP="Especifica el precio de una unidad en la línea de venta."';
                ...
                {
                    Editable = false;
                    ToolTip = 'Specifies the document number.', Comment = 'ESP="Especifica el número del documento."';
                    Visible = false;
                }
            ...
            group("&Line")
            {
                ...
                group("F&unctions")
                {
                    ...
                    action("Get &Price")
                    {
                        ...
                        Caption = 'Get Price', Comment = 'ESP="Obtener precio"';
                        Ellipsis = true;
                        Image = Price;
                    ...
                    {
                        AccessByPermission = TableData "Price List Line" = R;
                        Caption = 'Get Line Discount', Comment = 'ESP="Obtener descuento de línea"';
                        Ellipsis = true;
                        Image = LineDiscount;
                    ...
                    action("E&xplode BOM")
                    {
                        ...
                        Caption = 'Explode BOM', Comment = 'ESP="Desglosar L.M."';
                        Image = ExplodeBOM;
                ...
                {
                    Caption = 'Item Availability by', Comment = 'ESP="Disponibilidad del artículo por"';
