report 50023 "Modelo 180"
{
    Caption = 'Make 180 Modell', Comment = 'ESP="Generar modelo 180"';
    ProcessingOnly = true;
    ApplicationArea = All;
        ...
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Movs. retenciones"; "Movs. retenciones")
            {
                ...
                begin
                    ...
                    "Movs. retenciones".SETRANGE("Tipo retención", "Movs. retenciones"."Tipo retención"::Alquiler);
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '180 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 180 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 180 year %1 month %2.txt', Comment = 'ESP="Declaración 180 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '180' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '180' + FiscalYear + CompanyVATRegNo +
...
NOT (VATEntry."Document Type" = VATEntry."Document Type"::" "))
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2180' + FiscalYearText + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
