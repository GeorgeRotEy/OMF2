report 50022 "Modelo 115"
{
    Caption = 'Make 115 Model', Comment = 'ESP="Generar modelo 115"';
    ProcessingOnly = true;
    ApplicationArea = All;
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '115 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 115 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 115 year %1 month %2.txt', Comment = 'ESP="Declaración 115 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '115' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '115' + FiscalYear + CompanyVATRegNo +
...
NOT (VATEntry."Document Type" = VATEntry."Document Type"::" "))
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2115' + FiscalYearText + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
