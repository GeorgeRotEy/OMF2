report 50028 "Modelo 190"
{
    Caption = 'Make 190 Declaration', Comment = 'ESP="Generar declaración 190"';
    ProcessingOnly = true;
    ApplicationArea = All;
        ...
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Movs. retenciones"; "Movs. retenciones")
            {
                ...
                begin
                    ...
                    "Movs. retenciones".SETRANGE("Tipo retención", "Movs. retenciones"."Tipo retención"::Profesionales);
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '190 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 190 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 190 year %1 month %2.txt', Comment = 'ESP="Declaración 190 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '190' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '190' + FiscalYear + CompanyVATRegNo +
          ...
          DeclareNumText + PADSTR('', 1, ' ') + ReplacementText + PrevDeclareNumText +
...
NOT (VATEntry."Document Type" = VATEntry."Document Type"::" "))
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2190' + FiscalYear + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
                  PADSTR(FormatTextName(rPilaMovs."Customer/Vendor Name"), 40, ' ') + rPilaMovs."Resident ID" + rPilaMovs.Clave + rPilaMovs.Subclave + FormatTextAmt(rPilaMovs.Base, FALSE) + FormatTextAmt(rPilaMovs.Importe, FALSE) + PADSTR('', 1, ' ') + PADSTR('', 49, '0') +
                  PADSTR('', 9, ' ') + PADSTR('', 2, '0') + PADSTR('', 1, ' ') + PADSTR('', 85, '0') + PADSTR('', 1, ' ') + PADSTR('', 39, '0');
