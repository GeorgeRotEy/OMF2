report 50109 "Main Accounting Book OFM v2"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/MainAccountingBookOFMv2.rdlc';
                ...
                begin
                    ...
                    END ELSE
                        ...
                        IF vTerceroII <> vTercero THEN BEGIN
                            ...
                            //KPMG ATS OMF030 08-03-2022. BEGIN
                            IF rGLacc."No." = '5720001' THEN
                                rGLacc.SETRANGE("Date Filter", 0D, CLOSINGDATE(vFinalDate))
                            ELSE
                                //KPMG ATS OMF030 08-03-2022. END
                            ...
                            //KPMG ATS OMF030 08-03-2022. BEGIN
                            //IF rGLacc."No." = '5720001' THEN
                            //rGLacc.SETRANGE("Date Filter",0D,CLOSINGDATE(vStartDate))
                            //rGLEntry.SETRANGE("Posting Date",0D,CLOSINGDATE(vFinalDate))
                            //ELSE
                            //KPMG ATS OMF030 08-03-2022. END
    ...
    var
        ...
        Text001Lbl: Label 'No se ha podido generar el informe, pongese en contacto con el administrador.';
