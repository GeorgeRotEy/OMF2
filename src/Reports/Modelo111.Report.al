report 50029 "Modelo 111"
{
    Caption = 'Make 111 Model', Comment = 'ESP="Generar modelo 111"';
    ProcessingOnly = true;
    ApplicationArea = All;
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '111 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 111 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 111 year %1 month %2.txt', Comment = 'ESP="Declaración 111 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '111' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '111' + FiscalYear + CompanyVATRegNo +
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2111' + FiscalYearText + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
