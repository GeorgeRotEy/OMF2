report 50027 "Modelo 216"
{
    Caption = 'Make 216 Model', Comment = 'ESP="Generar modelo 216"';
    ProcessingOnly = true;
    ApplicationArea = All;
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '216 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 216 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 216 year %1 month %2.txt', Comment = 'ESP="Declaración 216 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '216' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '216' + FiscalYear + CompanyVATRegNo +
...
NOT (VATEntry."Document Type" = VATEntry."Document Type"::" "))
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2216' + FiscalYearText + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
