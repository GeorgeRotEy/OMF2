report 50024 "Modelo 296"
{
    Caption = 'Make 296 Model', Comment = 'ESP="Generar modelo 296"';
    ProcessingOnly = true;
    ApplicationArea = All;
        ...
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Movs. retenciones"; "Movs. retenciones")
            {
                ...
                begin
                    ...
                    "Movs. retenciones".SETRANGE("Tipo retención", "Movs. retenciones"."Tipo retención"::"No residente");
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '296 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 296 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 296 year %1 month %2.txt', Comment = 'ESP="Declaración 296 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '296' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '296' + FiscalYear + CompanyVATRegNo +
...
NOT (VATEntry."Document Type" = VATEntry."Document Type"::" "))
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2296' + FiscalYearText + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
