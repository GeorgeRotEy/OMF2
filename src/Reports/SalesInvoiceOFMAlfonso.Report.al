report 59920 "SalesInvoice OFM_Alfonso"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/SalesInvoiceOFMAlfonso.rdlc';
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(FromSalesLine; FromSalesLine)
                        {
                        }
