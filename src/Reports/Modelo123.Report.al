report 50025 "Modelo 123"
{
    Caption = 'Make 123 Model', Comment = 'ESP="Generar modelo 123"';
    ProcessingOnly = true;
    ApplicationArea = All;
    ...
    var
        ...
        FromDate: Date;
        ToDate: Date;
        FileExportedMsg: Label '123 Declaration has been exported successfully under %1.', Comment = 'ESP="La declaración 123 se ha exportado correctamente en %1."';
        NoofRecords: Integer;
        ...
        FileNameTxt: Label 'Declaration 123 year %1 month %2.txt', Comment = 'ESP="Declaración 123 año %1 mes %2.txt"';
    ...
    begin
        ...
        DeclareNumText := '123' + FiscalYear + PeriodText + DeclarationNum;

        Txt1 :=
          '1' + '123' + FiscalYear + CompanyVATRegNo +
...
NOT (VATEntry."Document Type" = VATEntry."Document Type"::" "))
    ...
    begin
        ...
        IF rPilaMovs.FINDSET() THEN
            REPEAT
                txt := '2123' + FiscalYearText + rPilaMovs."VAT Registration No." + rPilaMovs."VAT Number" + PADSTR('', 9, ' ') +
